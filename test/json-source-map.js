...
\t]\n\
  ...
  describe('simple values', function() {
    ...
    it('should parse strings', function() {
      ...
      testParseFailElement('"foo" "foo"', 'string', 6);
    ...
    it('should parse numbers', function() {
      ...
      testParseFailElement('--123', 'number', 1);
      testParseFailToken('+123', '+', 0);
      testParseFailElement('01', 'number', 1);
      testParseFailElement('00', 'number', 1);
  ...
  function testParseFailElement(json, element, pos) {
    testParseFail(json, 'Unexpected ' + element + ' in JSON at position ' + pos);
  }
